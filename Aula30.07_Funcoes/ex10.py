...
# Ela tem uma quantia X para dar de entrada, uma taxa de juros é definida pelo banco e a pessoa pode escolher o número de parcelas que deseja financiar. ​
# Crie uma função que simule um financiamento, levando em consideração o regime de juros compostos. 
# O programa deve solicitar ao usuário o valor do veiculo, o valor da entrada, a taxa de juros e a quantidade de parcelas. 
